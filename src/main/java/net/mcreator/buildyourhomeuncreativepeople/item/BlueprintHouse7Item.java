...
public class BlueprintHouse7Item extends BuildyourhomeUncreativePeopleModElements.ModElement {
	@ObjectHolder("buildyourhome__uncreative_people:blueprint_house_7")
	public static final Item block = null;
	public BlueprintHouse7Item(BuildyourhomeUncreativePeopleModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blueprint_house_7");
		}
