...
public class BlueprintHouse3Item extends BuildyourhomeUncreativePeopleModElements.ModElement {
	@ObjectHolder("buildyourhome__uncreative_people:blueprint_house_3")
	public static final Item block = null;
	public BlueprintHouse3Item(BuildyourhomeUncreativePeopleModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blueprint_house_3");
		}
