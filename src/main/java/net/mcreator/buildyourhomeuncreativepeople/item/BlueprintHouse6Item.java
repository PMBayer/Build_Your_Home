...
public class BlueprintHouse6Item extends BuildyourhomeUncreativePeopleModElements.ModElement {
	@ObjectHolder("buildyourhome__uncreative_people:blueprint_house_6")
	public static final Item block = null;
	public BlueprintHouse6Item(BuildyourhomeUncreativePeopleModElements instance) {
		super(instance, 10);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blueprint_house_6");
		}
