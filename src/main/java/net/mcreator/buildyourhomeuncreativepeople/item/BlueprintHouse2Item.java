...
public class BlueprintHouse2Item extends BuildyourhomeUncreativePeopleModElements.ModElement {
	@ObjectHolder("buildyourhome__uncreative_people:blueprint_house_2")
	public static final Item block = null;
	public BlueprintHouse2Item(BuildyourhomeUncreativePeopleModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blueprint_house_2");
		}
