...
public class HologramstarsBlock extends BuildyourhomeUncreativePeopleModElements.ModElement {
	@ObjectHolder("buildyourhome__uncreative_people:hologramstars")
	public static final Block block = null;
	public HologramstarsBlock(BuildyourhomeUncreativePeopleModElements instance) {
		super(instance, 12);
